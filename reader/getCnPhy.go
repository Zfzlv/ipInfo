...
func New(path string) (*GetCnPhy, error) {
...
func (this *GetCnPhy) Close() {
	this.dbFileHandler.Close()
}

func (this *GetCnPhy) MemorySearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
...
func (this *GetCnPhy) BinarySearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
	if this.totalBlocks == 0 {
...
func (this *GetCnPhy) BtreeSearch(ipStr string) (ipInfo IpInfo, err error) {
	ipInfo = IpInfo{}
	ip, err := ip2long(ipStr)
